...
[[ "$(plutil -extract CFBundleShortVersionString raw "$INFO")" == "1.1.0" ]] || fail "unexpected version"
[[ "$(plutil -extract CFBundleVersion raw "$INFO")" == "2" ]] || fail "unexpected build number"
